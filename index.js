...
Require = (function() {
  function Require() {
    this.quest = fs.readdirSync('./node_modules').slice(1);
    this.packagesName = this.makePackagesName(this.quest);
    this.nodeModulesName = this.makeNodeModulesName(this.quest);
    this.makeCollection(this.packagesName, this.nodeModulesName);
  }
